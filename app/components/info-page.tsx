  ...
  zh: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: '临时保存', paragraphs: ['草稿仅保存在当前浏览器标签页的临时存储中，用于刷新页面后的恢复。关闭标签页后，浏览器会清除这份临时草稿。本网站当前不建立用户账户。'] },
  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: 'Temporary storage', paragraphs: ['Drafts are stored temporarily in the current browser tab so they can survive a refresh. Closing the tab clears this temporary draft. The site currently has no user accounts.'] },
