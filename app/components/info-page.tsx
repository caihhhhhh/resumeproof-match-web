...
const content: Record<'zh' | 'en', Record<InfoKind, { eyebrow: string; title: string; intro: string; updated?: string; sections: Section[] }>> = {
  zh: {
    ...
    privacy: {
      eyebrow: '隐私政策', title: '你的简历，不应该悄悄留下来。', updated: '更新日期：2026 年 8 月 25 日',
  ...
  en: {
    ...
    privacy: {
      eyebrow: 'Privacy policy', title: 'Your resume should not quietly linger.', updated: 'Last updated: August 25, 2026',
