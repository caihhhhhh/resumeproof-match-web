...
const copy = {
  zh: {
    ...
    titleOne: '对照岗位要求，',
    titleTwo: '把简历改清楚。',
    intro: '上传简历和岗位 JD，查看已有优势与证据缺口，审核修改建议，再导出可投递的简历。',
    primary: '开始一次匹配',
    secondary: '体验完整示例',
    example: '示例结果',
    lab: 'Alignment Lab',
    ...
    privacyBody: '文件优先在浏览器读取，草稿在当前标签页临时保留；主动保存的基础简历会留在此浏览器，直到你清除。开始分析后，简历与 JD 文字会发送至 AI 服务；扫描文件可能发送至视觉识别服务。所有修改仍需由你确认后才能导出。',
    finalAction: '开始匹配',
  },
  en: {
    navHow: 'How it works',
    ...
    titleOne: 'Match the role.',
    titleTwo: 'Make your experience clear.',
    ...
    privacyBody: 'Files are read in your browser, and drafts stay in the current tab; a base resume you choose to save stays in this browser until you clear it. Once analysis starts, resume and JD text is sent to an AI service; scanned files may use a visual recognition service. Nothing exports until you confirm the final text.',
